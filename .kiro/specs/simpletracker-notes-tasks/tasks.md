...
- [ ] 3. Generalized offline queue and sync engine
  ...
  - [-] 3.2 Write property test for offline queue FIFO order (Property 13)
  ...
  - [-] 3.4 Refactor sync engine for generic entity types
  ...
  - [ ] 3.5 Implement localStorage cache manager with LRU eviction
  ...
  - [~] 3.7 Write property test for shared items excluded from cache (Property 14)
...
- [ ] 5. Domain Zustand stores
  - [~] 5.1 Implement noteStore
  ...
  - [~] 5.2 Write property tests for noteStore (Properties 3, 5, 6, 12)
  ...
  - [~] 5.4 Write property tests for taskStore (Properties 4, 8, 11, 12)
  ...
  - [~] 5.6 Write property tests for projectStore (Properties 5, 7, 15)
  ...
  - [~] 5.7 Update modalStore for new modals
...
- [ ] 7. Application rebranding and navigation restructure
  - [~] 7.1 Rebrand application to simpleTracker
  ...
  - [~] 7.2 Restructure navigation to Notes/Tasks/Projects/Settings
  ...
  - [~] 7.3 Update App.tsx to remove budget logic and wire new stores
...
- [ ] 8. Notes UI pages
  - [~] 8.1 Implement NotesPage component
  ...
  - [~] 8.2 Implement NoteDetailPage component
  ...
  - [~] 8.3 Install react-markdown and remark-gfm dependencies
    - Add `react-markdown` and `remark-gfm` to package.json dependencies
    - _Requirements: 4.3_

- [ ] 9. Tasks UI pages
  - [~] 9.1 Implement TasksPage component
  ...
  - [~] 9.2 Implement TaskDetailPage component
...
- [ ] 10. Projects UI pages
  - [~] 10.1 Implement ProjectsPage component
  ...
  - [~] 10.2 Implement ProjectDetailPage component
...
- [ ] 11. Connectivity UI and sync status
  - [~] 11.1 Implement connectivity indicator in toolbar
  ...
  - [~] 11.2 Wire connectivity detection into App lifecycle
...
- [ ] 13. Settings page and data migration cleanup
  - [~] 13.1 Update SettingsPage for simpleTracker
  ...
  - [~] 13.2 Remove all budget-related source code
  ...
  - [~] 13.3 Update router configuration
...
- [ ] 14. Integration wiring and final polish
  - [~] 14.1 Wire shared item online-only behavior
  ...
  - [~] 14.2 Implement confirmation dialogs for delete operations
  ...
  - [~] 14.3 Wire Supabase config resolution (verify existing implementation)
  ...
  - [~] 14.6 Write integration tests for end-to-end flows
